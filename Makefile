...
KBUILD_CFLAGS   := -Wall -Wundef -Wno-gnu-variable-sized-type-not-at-end -Wstrict-prototypes -Wno-trigraphs -pipe \
...
CLANG_FLAGS	+= -no-integrated-as -Wno-gnu-variable-sized-type-not-at-end
